...
@section('title', 'Cambio de nombre')
            ...
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col s12">
                                    ...
                                    <div v-if="!nameChecked || taken">
                                        ...
                                        <button :disabled="!rulesClosed || !changed || loading || firstName === '' || lastName === '' || fullname.length > 17" class="btn blue waves-effect">Comprobar</button>

                                        <p>
                                            <small>Generar nombre:</small>
                                            <br>
                                            <a class="right"><a :disabled="!rulesClosed || loading" class="btn-flat dropdown-button waves-effect" @click.prevent="shuffle(true)"><i class="mdi mdi-human-male"></i></a></a>
                                            <a class="right"><a :disabled="!rulesClosed || loading" class="btn-flat dropdown-button waves-effect" @click.prevent="shuffle(false)"><i class="mdi mdi-human-female"></i></a></a>
                                        </p>
                ...
                <div v-cloak v-if="success" class="col l6 s12 ">
                    <div class="card-panel green white-text">
                        ...
                        <a href="{{ route('home') }}" class="btn white green-text waves-effect"><i class="material-icons left">home</i> Inicio</a>
                    </div>
                </div>
            </div>
        ...
        var app = new Vue({
            ...
            methods: {
                ...
                check: function() {
                    ...
                    this.changed = false;
                    this.success = false,
                        axios.post('{{ route('account-namechange-check') }}', {
                ...
                choose: function() {
                    this.loading = true;
                    axios.post('{{ route('account-namechange') }}',{
                        firstName: this.firstName,
                        lastName: this.lastName
                    })
                        .then(function(response) {
